...
A = np.array([
    # 赤  橙  黄  緑  青   紫  ピンク 白  グレー 黒  
    [1,   1,  1,  0.5, 0,   0,  0.5,  0.5, 0,  -1],    # 元気 
    [0.5, 0.5, 0.5, 1,  0.5, 0.5, 0.5,  0,   0,  0],     # 友情 
    [0.5, 1,  0.5, 0,  0,   0,  0.5,  0,   0.5, 1],     # 注意 
    [0,   0.5, 0.5, 1,  0.5, 0.5, 0,    0.5, 0.5, 0],     # 安らぎ 
...
# 印象語のリスト（行列Aの行））
impression_words = ["元気", "友情", "注意", "安らぎ", "明るい", "暗い", "冷静"]
